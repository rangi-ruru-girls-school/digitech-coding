<script context="module">
  export async function preload({ params, query }) {
    ...
    const res = await this.fetch(`js/objects/${params.slug}.json`);
...
<nav class="breadcrumb" aria-label="breadcrumbs">
  <ul>
    ...
    <li><a href="js/objects">Objects</a></li>
    <li class="is-active"><a href="js/objects/{project.slug}">{project.title}</a></li>
  </ul>
</nav>
...
{#if project.progressValue}
  <ProgressBar value={project.progressValue} max={project.progressMax} prev="js/objects/{project.prev}" next="js/objects/{project.next}" />
{/if}
